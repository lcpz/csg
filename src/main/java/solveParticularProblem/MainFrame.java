...
public class MainFrame extends JFrame
{
	...
	public Input readInputFromGUI()
	{
		...
		input.numOfAgents = Integer.parseInt(numOfAgents_textField.getText());
		...
		input.acceptableRatio = Double.parseDouble(ipAcceptableRatio_textField.getText()); // only relevant when running IP or ODP-IP
